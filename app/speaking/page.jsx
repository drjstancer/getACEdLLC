      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="border-t border-white/10 pt-16">
          <h2 className="text-4xl md:text-5xl font-serif mb-8">
            Bring Dr. Joel Stancer to Your Institution or Event.
          </h2>

          <p className="text-xl text-[#D8D3CA] leading-relaxed max-w-3xl mb-10">
            get ACEd, LLC partners with universities, pathway initiatives,
            leadership programs, conferences, nonprofits, and educational organizations seeking meaningful transformational impact.
          </p>
